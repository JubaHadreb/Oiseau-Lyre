		...
		if(isset($_POST['go'])){
			...
			$connexion->exec(" INSERT INTO partenaires VALUES(NULL, '$titre', '$image', '$url') ");
		...
		<div id="contenu_admin">
			...
			<div id="ajouter">
				...
				<h3 style="width: 219px;">Ajouter un partenaire</h3>
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" onsubmit="return valider();">
					...
					<input type="text" name="url" id="url" placeholder="Lien du partenaire" size="50" maxlength="50">
					<br><br>
